...
class Square:
    ...
    #Created calculateArea function for Square class to implement polymorphism
    ...
    #Created calculatePerimieter function for Square class to implement polymorphism
